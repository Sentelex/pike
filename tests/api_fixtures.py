...
def mock_additional_kwargs():
    ...
    return {"temperature": 0.5, "max_tokens": 250}
...
def mock_model_definition():
    return {
        ...
        "additonal_kwargs": mock_additional_kwargs,
    }
...
def mock_skill_with_model():
    return {mock_skill | {"model": mock_model_definition}}
...
def mock_agent_two_skills():
    return {mock_agent_one_skill()["skills"].append(mock_skill_with_model)}
                ...
                lcm.HumanMessage(
                    content=[
                        ...
                        },
                        {
                            ...
                            "data": attachment_database.keys()[0],
                        },
                    ]
                ),
            ]
...
@pytest.fixture
def additional_chat_without_messages():
    return {
        "ID": "81bddc2b-36e6-495a-a8e4-d5207a50f121",
        "name": "Second Chat",
        "pinned": True,
...
@pytest.fixture
def additional_chat_with_messages():
    return {
...
def mock_user():
    return {
        ...
        "used_credits": 14,
        "location": "Anaheim, CA",
        "agents": [mock_agent_one_skill, mock_agent_two_skills],
